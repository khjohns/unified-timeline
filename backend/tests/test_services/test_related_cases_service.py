...
class TestRelatedCasesService:
    ...
    def test_hent_state_fra_saker_success(
        self, mock_parse_event, service, mock_event_repository, mock_timeline_service
    ):
    ...
    @patch("services.related_cases_service.parse_event")
    def test_hent_state_fra_saker_handles_errors(
        self, mock_parse_event, service, mock_event_repository, mock_timeline_service
    ):
        ...
        mock_parse_event.side_effect = lambda e: Mock(event_type=e.get("event_type"))
        mock_timeline_service.compute_state.return_value = SakState(
            sak_id="SAK-001", sakstittel="Test"
        )
    ...
    def test_hent_state_fra_saker_skips_empty_events(
        self, service, mock_event_repository
    ):
    ...
    @patch("services.related_cases_service.parse_event")
    def test_hent_hendelser_fra_saker_success(
        self, mock_parse_event, service, mock_event_repository
    ):
        ...
        mock_event_repository.get_events.return_value = (mock_events, 1)
        mock_parse_event.side_effect = lambda e: Mock(
            event_type=e.get("event_type"), spor="grunnlag"
        )
    ...
    @patch("services.related_cases_service.parse_event")
    def test_hent_hendelser_fra_saker_with_spor_filter(
        self, mock_parse_event, service, mock_event_repository
    ):
        ...
        result = service.hent_hendelser_fra_saker(
            ["SAK-001"], spor_filter=["grunnlag", "frist"]
        )
    ...
    def test_hent_hendelser_fra_saker_handles_errors(
        self, service, mock_event_repository
    ):
    ...
    @patch("services.related_cases_service.parse_event")
    def test_get_related_cases_context_returns_both(
        self, mock_parse_event, service, mock_event_repository, mock_timeline_service
    ):
    ...
    @patch("services.related_cases_service.parse_event")
    def test_get_related_cases_context_with_filter(
        self, mock_parse_event, service, mock_event_repository, mock_timeline_service
    ):
    ...
    @patch("services.related_cases_service.parse_event")
    def test_hent_egne_hendelser_success(
        self, mock_parse_event, service, mock_event_repository
    ):
