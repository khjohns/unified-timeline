...
from models.events import EventType, GrunnlagEvent, GrunnlagData
...
class TestDataschemaUri:
    ...
    def test_dataschema_uri_with_base(self):
        ...
        assert uri == 'https://api.example.com/api/cloudevents/schemas/grunnlag_opprettet'
...
class TestEventTypeMapping:
    ...
    def test_event_types_have_correct_models(self):
        ...
        from models.events import GrunnlagData, VederlagData, FristData
