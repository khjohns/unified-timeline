...
import { KOEMorphAnimation, KOEMorphLoader } from '../components/svg-morph';
...
/>`}
          ...
          {/* ============================================
              TAB 8: SVG MORPH ANIMATION
              ============================================ */}
          {activeTab === 'svg-morph' && (
            <>
              {/* Info */}
              <Alert variant="info" title="SVG Morph-animasjon">
                Flytende, drømmeaktig animasjon der figurer smooth morpher til nye former.
                Bruker Flubber.js for path-interpolering.
              </Alert>

              {/* Hovedanimasjon */}
              <Card variant="outlined" padding="lg">
                <h2 className="text-xl font-semibold text-pkt-text-body-dark mb-4">
                  KOE-prosessen - Smooth morphing
                </h2>
                <p className="text-pkt-text-body-subtle mb-6">
                  Figurene flyter jevnt fra en tilstand til neste: arbeider → tenker → skriver →
                  brev → mottar → avslag → diskusjon → forhandling → avtale.
                </p>
                <div className="flex justify-center py-8 bg-gradient-to-br from-slate-50 to-slate-100 rounded-lg">
                  <KOEMorphAnimation
                    size={250}
                    phaseDuration={2500}
                    morphDuration={1500}
              ...
              <Card variant="outlined" padding="lg">
                <h2 className="text-xl font-semibold text-pkt-text-body-dark mb-4">
                  Som loading-indikator
                </h2>
                <p className="text-pkt-text-body-subtle mb-4">
                  Kompakt versjon uten label - perfekt for loading states.
                </p>
                <div className="flex gap-8 items-center justify-center py-6">
                  <div className="text-center">
                    <p className="text-xs text-pkt-text-body-subtle mb-3">Liten (60px)</p>
                    <KOEMorphLoader size={60} />
                  </div>
                  <div className="text-center">
                    <p className="text-xs text-pkt-text-body-subtle mb-3">Medium (80px)</p>
                    <KOEMorphLoader size={80} />
                  </div>
                  <div className="text-center">
                    <p className="text-xs text-pkt-text-body-subtle mb-3">Stor (120px)</p>
                    <KOEMorphLoader size={120} />
                  </div>
                </div>
              </Card>
              ...
              <Card variant="outlined" padding="lg">
                ...
                <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-8 flex justify-center">
                  <KOEMorphAnimation
                    size={200}
                    phaseDuration={2000}
                    morphDuration={1200}
              ...
              <Card variant="outlined" padding="lg">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-semibold text-pkt-text-body-subtle mb-2">Full animasjon:</h3>
                    <pre className="bg-slate-100 p-3 rounded text-sm overflow-x-auto">
{`<KOEMorphAnimation
  size={250}
  phaseDuration={2500}
...
/>`}
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-pkt-text-body-subtle mb-2">Som loader:</h3>
                    <pre className="bg-slate-100 p-3 rounded text-sm overflow-x-auto">
{`<KOEMorphLoader size={80} />`}
                    </pre>
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold text-pkt-text-body-subtle mb-2">Splash screen:</h3>
                    <pre className="bg-slate-100 p-3 rounded text-sm overflow-x-auto">
{`<KOEMorphSplash onComplete={() => navigate('/app')} />`}
                    </pre>
                  </div>
                </div>
              </Card>
