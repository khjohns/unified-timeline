...
export const forseringKeys = {
  all: ['forsering'] as const,
  kontekst: (sakId: string) => ['forsering', sakId, 'kontekst'] as const,
  kandidater: () => ['forsering', 'kandidater'] as const,
  byRelatert: (sakId: string) => ['forsering', 'by-relatert', sakId] as const,
  validerGrunnlag: (sakId: string) => ['forsering', sakId, 'valider-grunnlag'] as const,
};
