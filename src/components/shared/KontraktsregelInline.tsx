...
const HJEMMEL_INNHOLD: Record<Hjemmel, {
  ...
  '§24.2.2': {
    inline: 'Byggherren må svare «uten ugrunnet opphold» på varsel fra totalentreprenøren. Innebærer svaret en endring, skal byggherren utstede endringsordre (§31.3). Gjør han ikke det, må totalentreprenøren varsle etter §32.2.',
    konsekvens: 'Ved sen varsling (§32.2) taper totalentreprenøren retten til å påberope at svaret innebærer en endring. Fastholder byggherren sin løsning uten at det er en endring, bærer byggherren risikoen for sitt valg.',
    paragraf5: {
      paaberoper: 'BH',
      tekst: 'Byggherren må påberope sen varsling skriftlig «uten ugrunnet opphold» – ellers anses varselet gitt i tide.',
    },
    systematikk: {
      label: 'Kontroll, varsling og svar (§24.2.2)',
      innhold: [
        { ref: '5-ukersfrist', tekst: 'TE har 5 uker fra kontraktsinngåelse til å gjennomgå byggherrens materiale og varsle om forhold som ikke oppfyller §14' },
        { ref: 'BHs svarplikt', tekst: 'Byggherren må svare «uten ugrunnet opphold» og gi beskjed om hvordan TE skal forholde seg' },
        { ref: 'Fastholdelse', tekst: 'Fastholder BH sin løsning → BH bærer risikoen for sitt valg (ingen endring, men risikoovergang)' },
        { ref: 'Endring uten EO', tekst: 'Innebærer BHs svar en endring uten at EO utstedes → TE må varsle etter §32.2' },
        { ref: 'Frist/vederlag', tekst: 'Krav varsles etter §33.4 (frist) og §34.1.1 (vederlag ved endring) eller §34.1.2 (ved svikt)' },
      ],
    },
  },
  '§25.1.2': {
