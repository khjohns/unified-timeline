 ...
 *
 * Confirmation modal for TE (contractor) to accept BH's response on a track.
...
> = {
  grunnlag: {
    title: 'Godta svar på ansvarsgrunnlag',
    labelNorwegian: 'ansvarsgrunnlaget',
    successMessage: 'Svaret er godtatt',
  },
  vederlag: {
    title: 'Godta svar på vederlagskrav',
    labelNorwegian: 'vederlagskravet',
    successMessage: 'Svaret er godtatt',
  },
  frist: {
    title: 'Godta svar på fristkrav',
