/**
 * RespondGrunnlagForm Component
 *
 * Reusable form for BH (client) to respond to a grunnlag claim,
 * or update an existing response (when lastResponseEvent is provided).
 * Extracted from RespondGrunnlagModal for use in both Modal and TrackFormView contexts.
 *
 * MODES:
...
export interface RespondGrunnlagFormProps {
  sakId: string;
  ...
  /** UPDATE MODE: Previous response event to update. If provided, form operates in update mode. */
  lastResponseEvent?: {
    event_id: string;
...
export function RespondGrunnlagForm({
  sakId,
  grunnlagEventId,
  grunnlagEvent,
  onSuccess,
  ...
  // Determine if this is a palegg case (§32.1) where frafall (§32.3 c) applies
  // Kun IRREG og VALGRETT er palegg - andre §32.2-tilfeller kan ikke "frafalles"
  const erPaalegg =
    grunnlagEvent?.hovedkategori === 'ENDRING' &&
  ...
  // Auto-restore backup on mount (form mounts/unmounts with modal)
          ...
          <div className="space-y-6">
            ...
            {erPassiv && (
              <Alert variant="danger" title="Passivitetsrisiko (§32.3)">
                ...
                <p className="mt-2">
                  Ved varsel etter §32.2 kan passivitet medfore at forholdet anses
                  som en endring. Hvis du avslår, bor du dokumentere hvorfor forsinkelsen
                  var begrunnet.
                </p>
              </Alert>
            )}
            ...
            {erEndringMed32_2 && (
              <SectionContainer
                ...
                description="Vurder om entreprenoren varslet om den påståtte endringen i tide."
              >
                <div className="space-y-3 sm:space-y-4">
                  ...
                  {erGrunnlagPrekludert && (
                    <Alert variant="danger" title="Preklusjon påberopt (§32.2)">
                      <p>
                        Du påberoper at entreprenoren varslet for sent og dermed taper retten til
                      ...
                      <p className="mt-2 text-sm">
                        ...
                        Du bor ta subsidiært stilling til vederlagspreklusjon (§34.1.2) i
                        vederlagssvaret.
                      </p>
                    </Alert>
                  )}
                  ...
                  {!erGrunnlagPrekludert && grunnlagVarsletITide === true && (
                    <Alert variant="info" title="Varslet i tide">
                      Du godtar at entreprenoren varslet om endringen i tide.
            ...
            {erGrunnlagPrekludert && (
              <Alert variant="warning" title="Subsidiær vurdering">
                ...
                holder eller forholdet likevel anses å utgjore en endring.
              </Alert>
            )}
              ...
              <div className="space-y-3 sm:space-y-4">
                    ...
                    render={({ field }) => (
                      ...
                      >
                        {BH_GRUNNLAGSVAR_OPTIONS.filter((opt) => {
                          ...
                          // Filter out "frafalt" if NOT palegg (§32.3 c gjelder kun §32.1 palegg)
                ...
                {selectedResultat === 'frafalt' && (
                  <Alert variant="info" title="Frafall av pålegget (§32.3 c)">
                    ...
                    utfores</strong>. Dette er en endelig beslutning for irregulære
                    endringer (§32.2). Entreprenoren trenger ikke å utfore det pålagte
                ...
                {selectedResultat === 'godkjent' && erForceMajeure && (
                  <Alert variant="success" title="Force Majeure - kun fristforlengelse (§33.3)">
                    <p>
                      ...
                      entreprenorens kontroll. Entreprenoren får kun rett til{' '}
                ...
                {selectedResultat === 'avslatt' && erForceMajeure && (
                  <Alert variant="warning" title="Konsekvens av avslag">
                    ...
                    <p className="mt-2">
                      Entreprenoren vil likevel kunne sende inn krav om fristforlengelse.
                ...
                {selectedResultat === 'avslatt' && !erForceMajeure && !erGrunnlagPrekludert && (
                  <Alert variant="warning" title="Konsekvens av avslag">
                    <p>
                      Saken markeres som <em>omtvistet</em>. Entreprenoren vil likevel
        ...
        {activeTab === 'begrunnelse' && (
          <div className="space-y-6">
            ...
            <FormField
              ...
              helpText={
                erGrunnlagPrekludert
                  ? 'Begrunn både preklusjonsinnsigelsen og din subsidiaere vurdering av ansvarsgrunnlaget'
                  : selectedResultat === 'avslatt'
                    ? 'Forklar hvorfor du mener forholdet er en del av kontrakten eller entreprenorens risiko'
