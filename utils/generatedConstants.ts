/**
 * Status codes and constants for the application.
 * These values correspond to CRM option set values.
 */
...
export function getSakStatusLabel(code: string): string {
...
export function getKoeStatusLabel(code: string): string {
  const labels: Record<string, string> = {
    '100000001': 'Utkast',
...
export function getBhSvarStatusLabel(code: string): string {
  const labels: Record<string, string> = {
    '300000001': 'Utkast',
    '100000004': 'Godkjent',
...
export function getBhVederlagSvarLabel(code: string): string {
  const labels: Record<string, string> = {
...
export function getVederlagsmetoderLabel(code: string): string {
  const labels: Record<string, string> = {
