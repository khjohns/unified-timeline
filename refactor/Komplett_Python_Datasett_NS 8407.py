...
# Definerer gyldige beregningsmetoder iht. NS 8407
Vederlagsmetode = Literal[
    "Enhetspriser (34.3)", 
    "Regningsarbeid (34.4)", 
...
TypeKrav = Literal["Tid", "Penger", "Tid og Penger"]
...
class Underkategori(TypedDict):
    ...
    beskrivelse: str
    varselkrav_ref: str         # Hjemmel for varslingsplikt
    
class Hovedkategori(TypedDict):
    kode: str
    label: str
    beskrivelse: str
    hjemmel_frist: str                  # Hjemmel i pkt. 33
    hjemmel_vederlag: Optional[str]     # Hjemmel i pkt. 34 (None for FM)
    standard_vederlagsmetode: Vederlagsmetode
    type_krav: TypeKrav                 # Hjelpefelt for logikk
    underkategorier: List[Underkategori]

krav_struktur_ns8407_komplett: List[Hovedkategori] = [
    {
        "kode": "ENDRING",
        "label": "Endringer",
