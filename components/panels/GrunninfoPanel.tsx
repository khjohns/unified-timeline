  ...
  return (
    <div className="space-y-6">
      ...
      <FieldsetCard legend="Prosjekt">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <InputField className="md:col-span-6" id="sak.prosjekt_navn" label="Prosjekt" value={sak.prosjekt_navn} onChange={e => handleChange('prosjekt_navn', e.target.value)} required error={errors['sak.prosjekt_navn']} />
          <InputField className="md:col-span-6" id="sak.kontrakt_referanse" label="Kontraktsreferanse" value={sak.kontrakt_referanse} onChange={e => handleChange('kontrakt_referanse', e.target.value)} required error={errors['sak.kontrakt_referanse']} />
          <InputField className="md:col-span-6" id="sak.entreprenor" label="Entreprenør (TE)" value={sak.entreprenor} onChange={e => handleChange('entreprenor', e.target.value)} required error={errors['sak.entreprenor']} />
          <InputField className="md:col-span-6" id="sak.byggherre" label="Byggherre (BH)" value={sak.byggherre} onChange={e => handleChange('byggherre', e.target.value)} required error={errors['sak.byggherre']} />
        </div>
      </FieldsetCard>
    </div>
  );
