    ...
    <div className="space-y-6">
      ...
      <FieldsetCard legend="Byggherremøte om KOE" isBhPanel>
         <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <DateField className="md:col-span-6" id="bh_svar.mote_dato" label="Dato for møte" value={bh_svar.mote_dato} onChange={value => handleChange('mote_dato', value)} />
            <TextareaField className="md:col-span-12" id="bh_svar.mote_referat" label="Referanse til møtereferat" value={bh_svar.mote_referat} onChange={e => handleChange('mote_referat', e.target.value)} minHeight="60px" />
         </div>
      </FieldsetCard>
      ...
      {koe.vederlag.krav_vederlag && (
        <FieldsetCard legend="Svar på Vederlagskrav" isBhPanel>
          ...
          <div className="mt-6 pt-6 border-t border-border-color">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              <SelectField className="md:col-span-6" id="bh_svar.vederlag.bh_svar_vederlag" label="Svar på krav om vederlag" value={bh_svar.vederlag.bh_svar_vederlag} onChange={value => handleChange('vederlag.bh_svar_vederlag', value)} options={vederlagSvarOptions} />
              <InputField className="md:col-span-6" id="bh_svar.vederlag.bh_godkjent_vederlag_belop" label="Godkjent beløp (NOK)" type="number" value={bh_svar.vederlag.bh_godkjent_vederlag_belop} onChange={e => handleChange('vederlag.bh_godkjent_vederlag_belop', e.target.value)} error={errors['bh_svar.vederlag.bh_godkjent_vederlag_belop']} formatAsNumber />
            </div>
            <div className="mt-4">
      ...
      {koe.frist.krav_fristforlengelse && (
        <FieldsetCard legend="Svar på Fristforlengelse" isBhPanel>
            ...
            <div className="mt-6 pt-6 border-t border-border-color">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    <SelectField className="md:col-span-6" id="bh_svar.frist.bh_svar_frist" label="Svar på krav om frist" value={bh_svar.frist.bh_svar_frist} onChange={value => handleChange('frist.bh_svar_frist', value)} options={fristSvarOptions} />
                    <InputField className="md:col-span-6" id="bh_svar.frist.bh_godkjent_frist_dager" label="Godkjente dager" type="number" min={0} value={bh_svar.frist.bh_godkjent_frist_dager} onChange={e => handleChange('frist.bh_godkjent_frist_dager', e.target.value)} error={errors['bh_svar.frist.bh_godkjent_frist_dager']} />
                    <DateField className="md:col-span-12" id="bh_svar.frist.bh_frist_for_spesifisering" label="Frist for spesifisering (hvis aktuelt)" value={bh_svar.frist.bh_frist_for_spesifisering} onChange={value => handleChange('frist.bh_frist_for_spesifisering', value)} />
                </div>
                <div className="mt-4">
      ...
      <FieldsetCard legend="Signatur (For Byggherre)" isBhPanel>
         <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <DateField className="md:col-span-6" id="bh_svar.sign.dato_svar_bh" label="Dato for BHs svar" value={bh_svar.sign.dato_svar_bh} onChange={value => handleChange('sign.dato_svar_bh', value)} required />
            <InputField className="md:col-span-6" id="bh_svar.sign.for_byggherre" label="Signatur" value={bh_svar.sign.for_byggherre} onChange={e => handleChange('sign.for_byggherre', e.target.value)} required placeholder="Navn på signatar" />
         </div>
      </FieldsetCard>
    </div>
  );
