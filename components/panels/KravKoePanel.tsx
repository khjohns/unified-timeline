          ...
          <FieldsetCard legend="Detaljer om Vederlagsjustering">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <TextareaField className="md:col-span-2" id="koe.vederlag.krav_vederlag_begrunnelse" label="Begrunnelse/kalkyle" value={koe.vederlag.krav_vederlag_begrunnelse} onChange={e => handleChange('vederlag.krav_vederlag_begrunnelse', e.target.value)} readOnly={disabled} />
                </div>
              </div>
          </FieldsetCard>
        </div>
          ...
          <FieldsetCard legend="Detaljer om Fristforlengelse">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <InputField id="koe.frist.krav_frist_antall_dager" label="Antall dager" type="number" min={0} step={1} value={koe.frist.krav_frist_antall_dager} onChange={e => handleChange('frist.krav_frist_antall_dager', e.target.value)} error={errors['koe.frist.krav_frist_antall_dager']} readOnly={disabled} />
                    ...
                    <TextareaField className="md:col-span-2" id="koe.frist.krav_frist_begrunnelse" label="Begrunnelse (årsakssammenheng)" value={koe.frist.krav_frist_begrunnelse} onChange={e => handleChange('frist.krav_frist_begrunnelse', e.target.value)} readOnly={disabled} />
                </div>
              </div>
          </FieldsetCard>
        </div>
